...
enum Kraftstoff{Benzin,Diesel,Erdgas,Flüssiggas};
enum verkehrsmittel {Eigene,Carsharing,Fernverkehr,SonstigerBahnfernverkehr,ZugNahverkehr,ÖPNV,Reisebus,Fahrrad,};
