...
public class Controller {
    String Name;
    int Alter, Gewicht;
    application.Geschlecht Geschlecht;

    public Controller(String Name, int Alter, int Gewicht, application.Geschlecht Geschlecht) {
        this.Name = Name;
        this.Alter = Alter;
        this.Gewicht = 0;
        Geschlecht = application.Geschlecht.Männlich;
    }

    public Controller(ModuleLayer.Controller model) {
